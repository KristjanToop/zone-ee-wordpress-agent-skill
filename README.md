...
GitHub READMEs cannot safely run an installation on someone else's computer with one click. The badges above open the skill page, and the commands are intentionally explicit about the agent and installation scope.
